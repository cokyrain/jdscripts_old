...
[task_local]
#京喜工厂
10 * * * * https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_dreamFactory.js, tag=京喜工厂, enabled=true

================Loon==============
[Script]
cron "10 * * * *" script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_dreamFactory.js,tag=京喜工厂

===============Surge=================
京喜工厂 = type=cron,cronexp="10 * * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_dreamFactory.js

============小火箭=========
京喜工厂 = type=cron,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_dreamFactory.js, cronexpr="10 * * * *", timeout=200, enable=true
...
function updateTuanIds(url = 'https://gitee.com/lxk0301/updateTeam/raw/master/jd_updateFactoryTuanId.json') {
  return new Promise(resolve => {
