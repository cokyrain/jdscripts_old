...
[task_local]
#口袋书店
1 8,12,18 * * * https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_bookshop.js, tag=口袋书店, enabled=true

================Loon==============
[Script]
cron "1 8,12,18 * * *" script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_bookshop.js,tag=口袋书店

===============Surge=================
口袋书店 = type=cron,cronexp="1 8,12,18 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_bookshop.js

============小火箭=========
口袋书店 = type=cron,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_bookshop.js, cronexpr="1 8,12,18* * *", timeout=200, enable=true
 */
const $ = new Env('口袋书店');
...
let inviteCodes = [
  '15576db078ff4e1a839870b0194bf07b@fd4cfc07cbab4cd7b2d55546fa517a17',
  '15576db078ff4e1a839870b0194bf07b@fd4cfc07cbab4cd7b2d55546fa517a17'
]
