 ...
 */
/*
东东小窝 https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_small_home.js
现有功能：
...
[task_local]
#东东小窝
16 0 * * * https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_small_home.js, tag=东东小窝, img-url=https://raw.githubusercontent.com/58xinian/icon/master/ddxw.png  enabled=true

================Loon==============
[Script]
cron "16 0 * * *" script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_small_home.js, tag=东东小窝

===============Surge=================
东东小窝 = type=cron,cronexp="16 0 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_small_home.js

============小火箭=========
东东小窝 = type=cron,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_small_home.js, cronexpr="16 0 * * *", timeout=200, enable=true
 */
const $ = new Env('东东小窝');
...
function updateInviteCode(url = 'https://gitee.com/lxk0301/updateTeam/raw/master/jd_updateSmallHomeInviteCode.json') {
  return new Promise(resolve => {
