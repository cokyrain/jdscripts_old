...
[task_local]
#京东工厂
10 * * * * https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_jdfactory.js, tag=东东工厂, enabled=true

================Loon==============
[Script]
cron "10 * * * *" script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_jdfactory.js,tag=东东工厂

===============Surge=================
东东工厂 = type=cron,cronexp="10 * * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_jdfactory.js

============小火箭=========
东东工厂 = type=cron,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_jdfactory.js, cronexpr="10 * * * *", timeout=200, enable=true
 */
const $ = new Env('东东工厂');
...
const inviteCodes = [`T019ufx0SBoE8FzRIxj9nPACjVWnYaS5kRrbA@T0225KkcRR4b9laEdBP2wfUOIgCjVWnYaS5kRrbA@T023u_txQxYZ81bKIx_ylf4PctsCjVWnYaS5kRrbA`, 'T019ufx0SBoE8FzRIxj9nPACjVWnYaS5kRrbA@T0225KkcRR4b9laEdBP2wfUOIgCjVWnYaS5kRrbA@T023u_txQxYZ81bKIx_ylf4PctsCjVWnYaS5kRrbA'];
!(async () => {
  await requireConfig();
  if (!cookiesArr[0]) {
