...
[task_local]
# 京东赚赚
0 0 * * * https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_jdzz.js, tag=京东赚赚, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdzz.png, enabled=true

================Loon==============
[Script]
cron "0 0 * * *" script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_jdzz.js,tag=京东赚赚

===============Surge=================
京东赚赚 = type=cron,cronexp="0 0 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_jdzz.js

============小火箭=========
京东赚赚 = type=cron,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_jdzz.js, cronexpr="0 0 * * *", timeout=200, enable=true
 */
const $ = new Env('京东赚赚');
...
const inviteCodes = [
  `Sufx0SBoE8FzRIxj9nPA@S5KkcRR4b9laEdBP2wfUOIg@Su_txQxYZ81bKIx_ylf4Pcts`,
  `Sufx0SBoE8FzRIxj9nPA@S5KkcRR4b9laEdBP2wfUOIg@Su_txQxYZ81bKIx_ylf4Pcts`
]
!(async () => {
  $.tuanList = []
